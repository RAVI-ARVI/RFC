...
const CustomerViewPage = () => {
  ...
  const { mutate} = useMutation((deleteID) => {
  ...
  const { mutate:deleteLoan} = useMutation((loanID) => {
                          ...
                          loansData.map((element) => {
                            return (
                              <TableRow className="bg-accent" key={element?._id}>
                                ...
                                <TableCell >
                                  {element.interestDuePeriod || "*" }
                                </TableCell>
                                <TableCell >
                                  {element.status}
                                </TableCell>
                                <TableCell>
                                  <Trash onClick={()=>deleteLoan(element._id)} className="cursor-pointer" />
                                </TableCell>
                              </TableRow>
                            );
                          })
                          ...
                          transactionData?.map((element) => {
                            return (
                              <TableRow className="bg-accent" key={element?._id}>
                                ...
                                <TableCell>
                                  <Trash onClick={()=>mutate(element._id)} className="cursor-pointer" />
                                </TableCell>
                                {/* <TableCell className="font-medium">
                                  {element?.title}
                                </TableCell>
